...
function Experiment(baseobj) {
    ...
    $.extend(this, baseobj);
    this.consentFormDiv = '<div id="consent">By accepting this HIT, you confirm that you have read and understood the <a target="_blank" href="' + baseobj.rsrbConsentFormURL +
