               ...
               continueButton(function() {
                     ...
                     if ($("#platform").val() === 'mturk') {
                        ...
                        const formElement = document.querySelector('form#mturk_form');
                            ...
                            // While unchecked checkboxes are contained in formElement, they are not includes in the
                            ...
                            // if we want to come up with a general way of including even empty checkboxes we would
                            // somehow have to catch this BEFORE we call FormData, e.g, by checking whether there are
                            // checkboxes without ANY checked value and then writing some default (NULL?) value into
